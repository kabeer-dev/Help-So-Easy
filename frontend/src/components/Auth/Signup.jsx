...
function Signup() {
  ...
  async function submit (){
    setError('')
    if(password !== confirmPassword) return (setError('Password is Not Matched'))


    const items = {firstName, lastName, email,  password}
    let result = await fetch('http://localhost:5000/api/v1/auth/signup', {method: 'POST',
    headers:{
        ...
        <div className="col-lg-4 offset-lg-2">
          <div className="auth-form" >
            <div className="container">
              <h4 className="welcome-txt">Welcome!</h4>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <span className="input-txt">First Name</span>
                  <input className="input-style" type="text" name='firstName' onChange={(e) => setFirstName(e.target.value)}/>
                </div>
                <div className="col-lg-6">
                  <span className="input-txt">Last Name</span>
                  <input className="input-style" type="text" name='lastName' onChange={(e) => setLastName(e.target.value)}/>
                </div>
              </div>
              ...
              <div className="row mt-3">
                ...
                <div className="col-lg-6">
                  <span className="input-txt">Confirm Password</span>
                  <input className="input-style" type="password" name='confirmPassword' onChange={(e) => setConfirmPassword(e.target.value)}/>
                </div>
              ...
              <div className="row mt-4">
                ...
                <div className="col-lg-4 signup-with-txt-set">
                  <span className="signup-with-txt">Sign up with </span>
                </div>
              ...
              <div className="row mt-4">
                <div className="col-lg-12 already-txt-set">
                  <p className="already-txt">
                    ...
                    <span onClick={() => navigate('/')} className="login-txt">Log in</span>
                  </p>
                </div>
              </div>
            </div>

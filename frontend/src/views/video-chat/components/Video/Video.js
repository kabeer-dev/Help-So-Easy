            ...
            >
              ...
              <div className={`chatSection ${!isShown ? 'd-none' : ''}`}>
                  ...
                  <div style={{
                    ...
                    Images will be automatically saved if storage permission is given. To save all the other files, you have to manually save them by clicking on them.
                  </div>
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  onChange={async (e) => {
                    if (e.target.files[0]) {
                      let replaceIndex = sendMsgFunc(`${call.name && call.name !== name ? call.name : otherUserName} is sending a file...`, true)

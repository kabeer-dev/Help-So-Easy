...
import WaitingForPermissions from "./components/WaitingForPermissions/WaitingForPermissions";
...
const Home = () => {
  ...
  async function allPermissionsAreEnabled()
  {
    ...
    return micAndCameraPerm  ? true : false;
  }
  ...
  async function checkingValidations() {
    ...
    if (!checkIfBrowserIsChrome()){
      ...
      if (permissionsEnabled) {
        ...
        setDescription("All permissions are required e.g microphone, camera, notifications etc.");
      }
    }
  }
  ...
  return (
    <>
      {
        (checkIfBrowserIsChrome() && permissionsChecked) ?
          <VideoState>
            <Video />
          ...
          <div>
            ...
            <div className="center-model" style={{ padding: '0px' }}>
                {/* <button style={{float: 'right', backgroundColor: 'white', borderColor: 'white'}} onClick={handleCrossBtn}><CloseIcon/></button> */}

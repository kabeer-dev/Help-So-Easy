...
import ModalMail from '../model/ModalMail';
...
const PlugingMail = ({ avatar, name, status, col, btnName }) => {
                ...
                <Grid item xs={12} alignItems="center">
                    <Grid container>
                        ...
                        <Grid item sx={{ pt: 2 }}>
                            ...
                            {open && <ModalMail open={open} close={closeModel} />}
                        </Grid>
                    </Grid>
                    <Grid item xs={12}>
                        <Typography>
